...
public class Semester
{
  ...
  /**
   * Function that generates the combinations of summers across the projection plan. Takes k is the
   * maximum amount of summers allowed, generate combinations like [summer 1: yes, summer 2: no],
  ...
  /**
   * Returns a list of all semester combinations, starting from the combination with no summers.
   * 
   * @param maxRegSemesters
   *          isthe total amount of regular semester needed (6 for a regular projection plan).
   * @param startSemester
   *          is 0 for a start in fall, and 1 for a start in spring example: [r,r,s,r,r,s,r,r] or
   *          [r,r,s,r,r,r,r]
   */
   ...
   *          of the form [0,0] for no summer, no summer. example: [0,0,1] means third summer is
  ...
  /**
   * Function that calculate how many summers we can add based on number of regular semesters
   * allowed and the start semester. For example, for 6 semesters starting in fall, we can only
  ...
  public static int getMaxSummers(int maxRegSemesters, int startSemester)
  {
    ...
    if(startSemester==1 && maxRegSemesters%2==0) max_summers=  (int) (Math.ceil(maxRegSemesters / 2.0) );
    else max_summers =  (int) (Math.ceil(maxRegSemesters / 2.0) - 1);
